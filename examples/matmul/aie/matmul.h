...
void aie_matmul_i8(const int8_t* input_a, const int8_t* input_b, int32_t* output,
...
//============================================================================//
void matmul_i8_impl_with_params(struct matmul_i8_params_t* params);
void matmul_i8_impl(const int8_t* input_a, const int8_t* input_b,
                    int32_t* output, int16_t row_dim, int16_t inner_dim,
                    int16_t col_dim);
void matmul_f32_impl_with_params(struct matmul_float_params_t* params);
